...
public class T2_getText_getAttribute {
     ...
     */
        ...
        if (actualPlaceHolderForUsername.equals(LoopCampConstants.EXPECTED_PLACEHOLDER_USERNAME)) {
            ...
            System.out.println("Expected placeholder for username: \"" + LoopCampConstants.EXPECTED_PLACEHOLDER_USERNAME + "\", DOES NOT match placeholder: \"" + actualPlaceHolderForUsername);
            System.err.println("TEST FAILED");
        }
    }
}
